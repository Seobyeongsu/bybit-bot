...
ADX_MIN = 16
ADX_STRONG = 25
PULLBACK_ATR_MULTIPLIER = 1.2
B_PULLBACK_VALID_BARS = 5

# 매물대 최소 필터
SR_LOOKBACK_BARS = 50
SR_BLOCK_ATR_MULTIPLIER = 0.8   # 저항/지지가 ATR 0.8배 이내면 진입 차단
...
def main():
    ...
    print(f"[{now_kst_str()}] === Bybit Auto Bot A-improved strategy start ===")
    bootstrap_state()
